...
function UVFeatures() {
    ...
    const seasonLabels = ['Spring 1', 'Spring 2', 'Spring 3', 'Summer 1', 'Summer 2', 'Summer 3', 'Autumn 1', 'Autumn 2', 'Autumn 3', 'Winter 1', 'Winter 2', 'Winter 3'];
    ...
    return (
        <>
            ...
            <div className="uv-precautions-container pt-8">
                <h2 className="text-center text-4xl mb-8 pt-16">Preventive measures for different UV Levels</h2>
            ...
            <section>
                ...
                <Link to="/pollenandhayfever" className='crazy-button2'>
                Learn More About Allergy and Hay Fever
            </Link>
                </div>
            </section>
