...
import skinImageOne from '../../assets/uv-1.jpg';
  ...
  return (
    <>
      <Row className='align-items-center my-5'>
        <Col md={6}>
          <h1 style={{ color: '#004085' }}>Protect Your Child's Skin</h1> {/* Soft blue color for headings */}
          <p>Learn how to prevent skin cancer and sunburn in kids</p>
        </Col>
        <Col md={6}>
          <div style={{ backgroundColor: '#e9ecef', height: '500px', width: '100%' }}>
            <img src={skinImageOne} alt="Sun Protection" style={{ height: '100%', width: '100%', objectFit: 'cover' }} />
          </div>
        </Col>
      </Row>
